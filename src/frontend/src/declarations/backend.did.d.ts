...
export interface _SERVICE {
  ...
  'addPaymentMethod' : ActorMethod<[string, string, string], PaymentId>,
  ...
  'removePaymentMethod' : ActorMethod<[PaymentId], undefined>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'submitBillPayment' : ActorMethod<[BillPayment], TransactionId>,
}
